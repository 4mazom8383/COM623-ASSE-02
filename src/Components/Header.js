...
const StyledLi = styled.li`
    ...
    a{text-decoration: none;color:white !important;display: flex; justify-content: center; align-items: center; font-size: 1em; }
  `;
          ...
          <StyledLi active={location.pathname === "/profile"}>
            <Link to="/profile">
              <Icon2 viewBox="0 0 28 28">
                <path d="M20.2175 16.636C19.1828 15.6558 17.9512 14.9301 16.6075 14.4909C18.0467 13.5518 18.9922 11.9802 18.9922 10.2031C18.9922 7.33413 16.5284 5 13.5 5C10.4716 5 8.00781 7.33413 8.00781 10.2031C8.00781 11.9802 8.95332 13.5518 10.3925 14.4909C9.0488 14.9301 7.81722 15.6558 6.7825 16.636C4.98819 18.3359 4 20.596 4 23H5.48437C5.48437 18.8128 9.08016 15.4062 13.5 15.4062C17.9198 15.4062 21.5156 18.8128 21.5156 23H23C23 20.596 22.0118 18.3359 20.2175 16.636ZM13.5 14C11.2901 14 9.49219 12.2967 9.49219 10.2031C9.49219 8.1095 11.2901 6.40625 13.5 6.40625C15.7099 6.40625 17.5078 8.1095 17.5078 10.2031C17.5078 12.2967 15.7099 14 13.5 14Z" fill="#D3D5DE" stroke="#D3D5DE" stroke-width="0.8"/>
              </Icon2>
              <span>Profile</span>
            </Link>
          </StyledLi>
